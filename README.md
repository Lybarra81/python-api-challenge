...
Module 6 Challenge
Due May 9 by 11:59pm Points 100 Submitting a text entry box or a website url
Background
...
Open the .gitignore file and type the following code on the first line:In the command line, type git status and press Enter. The output should indicate that the .gitignore file has been modified and the api_keys.py file is untracked.
